...
return [
    ...
    'filename' => '/usr/share/nginx/html/user/data/gantry5/themes/rt_interstellar/config/layouts_-_left_sidebar/layout.yaml',
    'modified' => 1498110496,
    'data' => [
        'version' => 2,
        'preset' => [
        ...
        'layout' => [
            ...
            '/footer/' => [
                0 => [
                    0 => 'position-position-6615 60',
                    1 => 'position-position-9514 40'
                ]
            ],
            '/copyright/' => [
                0 => [
...
<p>Vestibulum mollis, est id rhoncus volutpat, dolor velit tincidunt neque, vitae pellentesque ante sem eu nisl. <em>Donec facilisis</em>, magna eget elementum pellentesque.</p>'
            ...
            'position-position-6615' => [
                'title' => 'Footer A',
                'attributes' => [
                    'key' => 'footer-a'
                ]
            ],
            'position-position-9514' => [
                'title' => 'Footer B',
                'attributes' => [
                    'key' => 'footer-b'
                ]
